...
<template>
  <div class="rename-panel-container">
    <p class="rename-element">New name for the element :</p>
    <div class="rename-element">
      <input v-model="newName">
    </div>
    <div class="md-layout">
      <md-button class="md-layout-item"
                 v-on:click="renameMethod">Rename</md-button>
    </div>
    <hr />
...
export default {
  ...
  methods: {
    ...
    renameMethod(option, viewer) {
      this.currentNode.info.name.set(this.newName);
    }
  }
};
</script>
